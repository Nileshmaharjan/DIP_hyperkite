...
from models_dhp.nas.NAS import operations
from models_dhp.nas.NAS import gen_upsample_layer
...
class skip(nn.Module):
    ...
    def forward(self, data):
        ...
        """ Decoder  """
        up5 = self.up5(enc5) # H/16 x W/16 x 128
