...
# To optimize GPU computations with CuDNN (Cuda Deep Neural Network Library) for faster training
torch.backends.cudnn.benchmark = True

# SEEDS
# for reproducibility to obtain the same results or behaviour everytime the code is run
